...
package de.taskforce.tn5250j.rse.designerpart;

import org.eclipse.swt.widgets.Shell;

import de.taskforce.tn5250j.core.designerpart.CoreDesignerInfo;
...
public class DesignerInfo extends CoreDesignerInfo {
	...
	public boolean isTN5250JEqual(TN5250JInfo tn5250jInfo) {
		...
		if (rseProfil.equals(designerInfo.getRSEProfil()) &&
			rseConnection.equals(designerInfo.getRSEConnection()) && 
			getSession().equals(designerInfo.getSession()) &&
			getLibrary().equals(designerInfo.getLibrary()) &&
			getSourceFile().equals(designerInfo.getSourceFile()) &&
			getMember().equals(designerInfo.getMember())) {
			return true;
		}
		else {
			return false;
