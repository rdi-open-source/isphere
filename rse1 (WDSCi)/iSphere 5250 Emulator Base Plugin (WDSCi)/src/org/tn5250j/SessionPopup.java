...
public class SessionPopup implements TN5250jConstants {
    ...
    private void showHexMap() {
        ...
        message[0] = srp;
        String[] options = { LangTool.getString("hm.optInsert"), LangTool.getString("hm.optCancel") };
    ...
    public void doMeTransfer() {
        ...
        XTFRFile xtrf = new XTFRFile((Frame)SwingUtilities.getRoot(session), vt, session);
    ...
    public void doMeSpool() {
        ...
        try {
            org.tn5250j.spoolfile.SpoolExporter spooler = new org.tn5250j.spoolfile.SpoolExporter(vt, session);
            spooler.setVisible(true);
        } catch (NoClassDefFoundError ncdfe) {
            JOptionPane.showMessageDialog(session, LangTool.getString("messages.noAS400Toolbox"), "Error", JOptionPane.ERROR_MESSAGE, null);
        }
