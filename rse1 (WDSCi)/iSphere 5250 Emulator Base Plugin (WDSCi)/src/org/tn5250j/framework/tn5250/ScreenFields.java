...
public class ScreenFields implements TN5250jConstants {
     ...
     * </tr>
     * </table> Constant Value Description ignoreCase - Indicates whether the
     * search is case sensitive. True means that case will be ignored. False
     * means the search will be case sensitive.
    ...
    protected void readFormatTable(ByteArrayOutputStream baosp, int readType, CodePage codePage) {
