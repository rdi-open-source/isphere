 ...
 * image files:
 * 
 * JFileChooser chooser = new JFileChooser(); XTFRFileFilter filter = new
 * XTFRFileFilter( new String{"gif", "jpg"}, "JPEG & GIF Images")
...
public class XTFRFileFilter extends FileFilter {
     ...
     * XTFRFileFilter("jpg", "JPEG Image Images");
     * 
     ...
     * 
     * XTFRFileFilter filter = new XTFRFileFilter(); filter.addExtension("jpg");
