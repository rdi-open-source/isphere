...
public class TN5250jMultiSelectList extends JComponent implements Serializable {
    ...
    /**
     * Creates a new <code>TN5250jMultiSelectList</code> component with an
     * empty model.
     */
    ...
    /**
     * Creates a new <code>TN5250jMultiSelectList</code> component with an
     * empty model and the specified horizontal gap between components.
     */
    ...
    public void setSourceHeader(String header) {
        ...
        setSourceHeader(header, SwingConstants.LEFT);
    ...
    public void setSelectionHeader(String header) {
        ...
        setSelectionHeader(header, SwingConstants.LEFT);
