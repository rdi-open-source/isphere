 ...
 * <code>WizardPages</code> and add <code>WizardListener</code>'s for all
 * your Wizard fun.
 */
public class Wizard extends JPanel implements Serializable {
    ...
    public boolean next() {
        ...
        if (event != null) {
            ...
            for (; e.hasMoreElements();) {
                WizardListener listener = (WizardListener)e.nextElement();
    ...
    public void addWizardListener(WizardListener l) {
        if (listeners == null) listeners = new Vector(3);
