...
public class GuiGraphicBuffer implements ScreenOIAListener, ScreenListener, PropertyChangeListener, SessionConfigListener, ActionListener,
    ...
    public void loadProps() {
        ...
        if (config.isPropertyExists("colSeparator")) {
            if (getStringProperty("colSeparator").equals("Line")) colSepLine = 0;
            if (getStringProperty("colSeparator").equals("ShortLine")) colSepLine = 1;
            if (getStringProperty("colSeparator").equals("Dot")) colSepLine = 2;
            if (getStringProperty("colSeparator").equals("Hide")) colSepLine = 3;
        }
    ...
    public void propertyChange(PropertyChangeEvent pce) {
        ...
        if (pn.equals("colSeparator")) {
            if (pce.getNewValue().equals("Line")) colSepLine = 0;
            if (pce.getNewValue().equals("ShortLine")) colSepLine = 1;
            if (pce.getNewValue().equals("Dot")) colSepLine = 2;
            if (pce.getNewValue().equals("Hide")) colSepLine = 3;
        }
    ...
    public final void drawChar(Graphics2D g, int pos, int row, int col) {
        ...
        if (showHex && attributePlace) {
            ...
            g.drawChars(a, 1, 1, x + (int)(columnWidth / 2), (int)(y + rowHeight - (lm.getDescent() + lm.getLeading()) - 2));
            g.setFont(f);
        }
            ...
            if (useGui && (whichGui < FIELD_LEFT)) {
                ...
                if (underLine) {
                    ...
                    if (!useGui || guiShowUnderline) {
                        g.setColor(fg);
                        g.drawLine(x, (int)(y + (rowHeight - (lm.getLeading() + lm.getDescent()))), (int)(x + columnWidth),
                ...
                if (colSep) {
                    ...
                    case 2: // dot
                        ...
                        g.drawLine(x + columnWidth - 1, y + rowHeight - (int)lm.getLeading() - 3, x + columnWidth - 1, y + rowHeight
                            - (int)lm.getLeading() - 4);
                        break;
                    case 3: // hide
                        break;
