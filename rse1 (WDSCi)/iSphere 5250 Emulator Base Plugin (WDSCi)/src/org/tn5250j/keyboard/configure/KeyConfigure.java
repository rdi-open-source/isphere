...
public class KeyConfigure extends JDialog implements ActionListener, TN5250jConstants {
    ...
    private boolean isAvailable(KeyEvent ke) {
        ...
        if (exists) {
            ...
            int result = JOptionPane.showConfirmDialog(this, LangTool.messageFormat("messages.mapKeyWarning", args), LangTool
                .getString("key.labelKeyExists"), JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
    ...
    private KeyGetterInterface getMeAKeyProcessor() {
        ...
        try {
            ...
            if (!OperatingSystem.hasJava14()) className += "13";
