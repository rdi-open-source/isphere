...
public class DataAreaEditorAction extends ISeriesSystemBaseAction implements ISystemDynamicPopupMenuExtension {
    ...
    public DataAreaEditorAction() {
        ...
        setHelp("");
        setImageDescriptor(ISpherePlugin.getDefault().getImageRegistry().getDescriptor(ISpherePlugin.IMAGE_DATA_AREA));
    }
    ...
    public boolean supportsSelection(IStructuredSelection selection) {
        ...
        for (Iterator iterSelection = selection.iterator(); iterSelection.hasNext();) {
            ...
            if (ISeriesDataElementHelper.isDataArea(objSelection)) {
