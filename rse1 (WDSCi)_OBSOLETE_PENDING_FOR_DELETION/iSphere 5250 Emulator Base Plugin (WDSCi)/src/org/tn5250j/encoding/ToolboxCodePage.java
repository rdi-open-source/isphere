...
class ToolboxCodePage extends CodePage {
    ...
    public static CodePage getCodePage(String encoding) {
        if (CONVERTER_CONSTRUCTOR == null) return null;
        ...
        if (conv != null) return new ToolboxCodePage(encoding, conv);
    ...
    static final String[] acp = { "Big5", "Cp037", "Cp273", "Cp277", "Cp278", "Cp280", "Cp284", "Cp285", "Cp297", "Cp420", "Cp424", "Cp437", "Cp500",
        "Cp737", "Cp775", "Cp838", "Cp850", "Cp852", "Cp855", "Cp856", "Cp857", "Cp858", "Cp860", "Cp861", "Cp862", "Cp863", "Cp864", "Cp865",
        "Cp866", "Cp868", "Cp869", "Cp870", "Cp871", "Cp874", "Cp875", "Cp918",
        "Cp921",
        "Cp922",
        "Cp923", // IBM Latin-9.
