...
public class SendEMailDialog extends TN5250jFrame implements TN5250jConstants, Runnable {
                    ...
                    if (text.isSelected()) {
                        ...
                        for (int x = 0; x < l; x++, col++) {
                            ...
                            if (screenTxt[x] >= ' ' && ((screenExtendedAttr[x] & EXTENDED_5250_NON_DSP) == 0)) {
                                ...
                                if ((screenExtendedAttr[x] & EXTENDED_5250_UNDERLINE) != 0 && screenAttrPlace[x] != 1) {
                                    sb.append('_');
                                } else {
    ...
    private JPanel setupMailPanel(String fileName) {
        ...
        bodyScrollPane.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
