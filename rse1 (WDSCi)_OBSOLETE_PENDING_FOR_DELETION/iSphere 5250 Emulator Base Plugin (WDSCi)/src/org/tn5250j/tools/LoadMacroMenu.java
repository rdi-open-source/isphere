...
public final class LoadMacroMenu {
    ...
    private static TN5250jLogger log = TN5250jLogFactory.getLogger("org.tn5250j.tools.LoadMacroMenu");
     ...
     * @param session
     */
    private static void loadScripts(Vector vector, String path, File directory, SessionGUI session) {
