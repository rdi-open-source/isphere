...
public class WTDSFParser implements TN5250jConstants {
                ...
                case 0x51: // Create Window
                    ...
                    while (length > 0) {
                        ...
                        case 0x01: // Border presentation
                            ...
                            // System.out.println(" Depth = " + rows + " Width =
                            // " + cols);
                            // System.out.println(" type = " + type + " gui = "
                            // + gui);
                        ...
                        case 0x10: // Window title/footer
                            ...
                            System.out.println(" orientation " + Integer.toBinaryString(orientation) + " mAttr " + mAttr + " cAttr " + cAttr
    ...
    private void clearWindowBody(ScreenPlanes planes, int startPos, int depth, int width) {
        ...
        while (depth-- > 0) {
            ...
            //
            // // set left
            // planes.setScreenCharAndAttr(lastPos, (char) left, colorAttr,
            // false);
            //
            // if (gui) {
            ...
            // // set right
            // // screen[lastPos].setCharAndAttr((char) right, colorAttr,
            // false);
            // planes.setScreenCharAndAttr(lastPos,(char) right, colorAttr,
            // false);
            // if (gui) {
    ...
    private void defineSelectionField(int majLen) {
        ...
        try {
            ...
            int minLen = 0;
            majLen -= 21;
            System.out.println(" row: " + screen52.getCurrentRow() + " col: " + screen52.getCurrentCol() + " type " + typeSelection + " gui "
                + guiDevice + " withMnemonic " + Integer.toHexString(withMnemonic & 0xf0) + " noMnemonic " + Integer.toHexString(noMnemonic & 0xf0)
